	...
	"The parse method" should {
		...
		"take a valid response and return a case object" in {
			...
			actualResponse must_== ApplicationCharge(
					...
					url,										//returnUrl: Url,
					Some(parseDateTimeWithTimeZone("2009-12-12T15:15:50-05:00")),			//createdAt: Option[DateTime],
					Some(1749673018),		//id: Option[Int],
					Some("pending"),		//status: Option[String],
					true,								//test: Boolean,
					Some(parseDateTimeWithTimeZone("2009-12-12T15:15:50-05:00")),			//updatedAt: Option[DateTime],
					Some(new Url(Http(),
							None, 
							None, 

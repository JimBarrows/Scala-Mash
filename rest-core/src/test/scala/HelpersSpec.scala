...
object HelpersSpec extends Specification {
	...
	"Helpers" should {
		...
		"be able to parse optional boolean values" in {
		...
		"be able to parse boolean values" in {
			boolean( <goof><boolean/></goof>, "boolean") must be( false)
			boolean( <goof><boolean>0</boolean></goof>, "boolean") must be( false)
			boolean( <goof><boolean>1</boolean></goof>, "boolean") must be( true)
			boolean( <goof><boolean>f</boolean></goof>, "boolean") must be( false)
			boolean( <goof><boolean>t</boolean></goof>, "boolean") must be( true)
			boolean( <goof><boolean>F</boolean></goof>, "boolean") must be( false)
			boolean( <goof><boolean>T</boolean></goof>, "boolean") must be( true)
